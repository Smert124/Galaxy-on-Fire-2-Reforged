...
public final class LaserGun extends AbstractMesh implements AbstractGun {
	...
	private static int[] FLASH_KEYFRAMES = new int[]{0, 1, 9, 4};
	private Level level;
	...
	public LaserGun(Gun var1, int var2, Level var3) {
		...
		var2 -= 9; // Преобразование: 9->0, 10->1, 11->2, 12->3
		
		// Защита от выхода за границы
		if(var2 < 0) var2 = 0;
		if(var2 >= FLASH_KEYFRAMES.length) var2 = FLASH_KEYFRAMES.length - 1;
		if(var2 >= BEAM_UVs.length) var2 = BEAM_UVs.length - 1;
