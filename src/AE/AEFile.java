...
public final class AEFile {
	...
	public static Image cutImageRegion(Image sourceImage, int startCutX, int startCutY, int width, int height) {
		...
		if(startCutX < 0 || startCutY < 0 || width <= 0 || height <= 0 || startCutX + width > imageWidth || startCutY + height > imageHeight) {
	...
	public static Image Aliasing(Image input) {
	...
	public static Image loadImage(String var0, boolean var1) {
		...
		if(var1) {
			try {
				...
				/* for(int var4 = 0; var4 < var10; ++var4) { // HC
					byte var5 = var3[var4];
					var3[var4] = var3[var11 - var4 - var10];
					var3[var11 - var4 - var10] = var5;
				} */
				
				for(int var4 = 0; var4 < var10; ++var4) { // fishlabs
					byte var5 = var3[var4];
