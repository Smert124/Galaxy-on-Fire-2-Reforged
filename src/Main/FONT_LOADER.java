...
public final class FONT_LOADER extends Class_3e {
   ...
   public final void sub_c3(int var1) {
      ...
      if(var1 == -7 || var1 == 'e') { // quickmenu
         this.var_d2 |= 8192;
      }

      if(var1 == -6 || var1 == 'p') { // pause
         this.var_d2 |= 16384;
      }

      if(var1 == 49 || var1 == 'g') { // rocket
         this.var_d2 |= '\u8000';
      }

      if(var1 == 51 || var1 == 'w') { // boost
         this.var_d2 |= 65536;
      }

      if(var1 == 48 || var1 == 't') { // turret
         this.var_d2 |= 131072;
      }
      ...
      if(var1 == -5 || var1 == 10 || var1 == 'f') { // ok
         this.var_d2 |= 256;
      }

      if(var1 == 55 || var1 == 'x') { // autofire
         this.var_d2 |= 512;
      }

      if(var1 == 57 || var1 == 'q') { // autopilot
         this.var_d2 |= 1024;
      }
